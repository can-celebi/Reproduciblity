p1 = """# General Task: Classify Player's Strategic Thinking Level in a Voting Game
...
## Role: Experimental Economist

- Specialization: Level-k strategic thinking and message classification.
- Task: Interpret and classify players' strategic reasoning from their messages.
